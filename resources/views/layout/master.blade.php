...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="{{asset('')}}assets/images/66383fav.png" type="image/x-icon">
    <link rel="shortcut icon" href="{{asset('')}}assets/images/66383fav.png" type="image/x-icon age/x-icon"> <img src="{{asset('')}}assets/images/logo/ic-1.png"width= "30" height="30" alt=""><br>
    <title>Fototech Parivar Portal|Admin </title>
    <!-- Google font-->
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper"> 
          <div>
            <div class="logo-wrapper"><a href="{{route('admin/dashboard')}}"><img class="img-fluid for-light" src="{{asset('')}}assets/images/logo.jpeg" width=170 height=100 alt=""><img class="img-fluid for-dark" src="{{asset('')}}assets/images/logo/small-white-logo.png" alt=""></a>
              <div class="back-btn"><i class="fa fa-angle-left"></i></div>
            </div>
            <div class="logo-icon-wrapper"><a href="{{route('admin/dashboard')}}"><img class="img-fluid" src="{{asset('')}}assets/images/logo-icon.png" alt=""></a></div>
            <nav class="sidebar-main">
              <div class="left-arrow" id="left-arrow"><i data-feather="arrow-left"></i></div>
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  <li class="back-btn"><a href="{{route('admin/dashboard')}}"><img class="img-fluid" src="{{asset('')}}assets/images/logo-icon.png" alt=""></a>
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('user_table_request')}}">New User Requests</a></li>
                      <li><a href="{{route('user_table_cod_request')}}">New COD Payment Requests</a></li>
                      <li><a href="{{route('user_table')}}">All Users</a></li>
                      <li><a href="{{route('user_table_general')}}">All Users - General</a></li>
                      <li><a href="{{route('user_table_service_provider')}}">All Users - Service Providers</a></li>
                      <li><a href="{{route('user_table_free')}}">Free Users</a></li>
                      <li><a href="{{route('user_table_standard')}}">Standard Users</a></li>
                      <li><a href="{{route('user_table_premium')}}">Premium Users</a></li>
                      <li><a href="{{route('user_table_premium_plus')}}">Premium Plus Users</a></li>
                      <li><a href="{{route('user_table_non_paid')}}">All Non-Paid Users</a></li>
                      <li><a href="{{route('user_table_paid')}}">All Paid Users</a></li>
                      <li><a href="{{route('user')}}">Add new User</a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_seo_setting_options==1)
                  <li class="sidebar-list"> 
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li>
                        <label class="badge badge-light-primary" style="top: 5px">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-alert-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12" y2="16"></line>
                          </svg>
                        </label>
                        <span class="m-l-20 f-w-700 font-primary">Listing Category</span> 
                      </li>
                      <li><a href="{{route('seo_option')}}">SEO Options</a></li>
                      <li>
                        <label class="badge badge-light-primary" style="top: 5px">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-alert-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12" y2="16"></line>
                          </svg>
                        </label>
                        <span class="m-l-20 f-w-700 font-primary">Target Listings Promotion</span> 
                      </li>
                      <li><a href="{{route('seo_target')}}">All Pages</a></li>
                      <li><a href="{{route('seo_terget')}}">Add new page</a></li>
                      <li>
                        <label class="badge badge-light-primary" style="top: 5px">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-alert-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12" y2="16"></line>
                          </svg>
                        </label>
                        <span class="m-l-20 f-w-700 font-primary">General Promotion Pages </span> 
                      </li>
                      <li><a href="{{route('seo_general_all')}}">All Pages</a></li>
                      <li><a href="{{route('seo_general')}}">Add New Page</a></li>
                      <li>
                        <label class="badge badge-light-primary" style="top: 5px">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-alert-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12" y2="16"></line>
                          </svg>
                        </label>
                        <span class="m-l-20 f-w-700 font-primary">E-book & Digital Pages  </span> 
                      </li>
                      <li><a href="{{route('seo_ebook')}}">All Pages</a></li>
                      <li><a href="{{route('add_seo_ebook')}}">Add New Page</a></li>
                      <li>
                        <label class="badge badge-light-primary" style="top: 5px">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-alert-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12" y2="16"></line>
                          </svg>
                        </label>
                        <span class="m-l-20 f-w-700 font-primary">Google Analytics</span> 
                      </li>
                      <li><a href="{{route('google-analytics')}}">Google Analytics Code</a></li>
                      <li>
                        <label class="badge badge-light-primary" style="top: 5px">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-alert-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12" y2="16"></line>
                          </svg>
                        </label>
                        <span class="m-l-20 f-w-700 font-primary">Sitemap</span> 
                      </li>
                      <li><a href="{{route('seo_xml')}}">XML Sitemap</a></li>
                      <li>
                        <label class="badge badge-light-primary" style="top: 5px">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-alert-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12" y2="16"></line>
                          </svg>
                        </label>
                        <span class="m-l-20 f-w-700 font-primary">Meta tags</span> 
                      </li>
                      <li><a href="{{route('all_page')}}">All Pages</a></li>
                      <li><a href="{{route('seo_listing')}}">Listings SEO Options</a></li>
                      <li><a href="{{route('seo_blog')}}">Blog SEO Options</a></li>
                      <li><a href="{{route('seo_event')}}">Event SEO Options</a></li>
                      <li><a href="{{route('seo_product')}}">Product SEO Options</a></li>
                      <li><a href="{{route('seo_job')}}">Job SEO Options</a></li>
                      <li><a href="{{route('seo_expert')}}">Service Expert SEO Options</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                    ...
                    <ul class="sidebar-submenu">
                      <li>
                        ...
                        <span class="m-l-20 f-w-700 font-primary">Search List</span> 
                      </li>
                      <li><a href="{{route('search_list')}}">Search list</a></li>
                      <li><a href="{{route('search_list_add')}}">Add New</a></li>
                      <li>
                        <label class="badge badge-light-primary" style="top: 5px">
                          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-alert-circle"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12" y2="16"></line>
                          </svg>
                        </label>
                        <span class="m-l-20 f-w-700 font-primary">Search positions</span> 
                      </li>
                      <li><a href="{{route('search_position')}}">Change Positions</a></li>
                    </ul>
                  </li>
                  @endif
                  <!-- LISTINGS -->
                @if($footer->admin_listing_show==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                      <span>LISTINGS</span>
                    </a>
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('listing_table')}}">All Listings</a></li>
                      <li><a href="{{route('listing')}}">Add New Listings</a></li>
                      <li><a href="{{route('listing_duplicate')}}">Create Duplicate Listings</a></li>
                      <li><a href="{{route('claim_listing_table')}}">All Claim Requests</a></li>
                      <li><a href="{{route('listing_trash')}}">Trash listings</a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_category_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('listing_category_table')}}">All Category</a></li>
                      <li><a href="{{route('listing_category')}}">Add New Category</a></li>
                      <li><a href="{{route('listing_sub_category_table')}}">All Sub Category</a></li>
                      <li><a href="{{route('listing_sub_category')}}">Add New Sub Category</a></li>
                      <li><a href="{{route('listing_category_position')}}">Change Category Position</a></li>
                    </ul>
                  </li>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      ...
                      <span>Listing Promotions</span>
                    </a>
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('listing_promotion_table')}}">All Promotions</a></li>
                      <li><a href="{{route('listing_promotion')}}">Create New Promotions</a></li>
                      <li><a href="{{route('listing_point_table')}}">All Points History</a></li>
                      <li><a href="{{route('listing_point')}}">Points Settings</a></li>
                      
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_enquiry_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                      ...
                      <span>Enquiry & Get Quote</span>
                    </a>
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('enquiry_listing_table')}}">All Enquiry</a></li>
                      <li><a href="{{route('save_enquiry_listing_table')}}">Saved Enquiry</a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_review_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('reviwe_listing_table')}}">All Reviews</a></li>
                      <li><a href="{{route('save_reviwe_listing_table')}}">Saved Reviews</a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_listing_filter_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                      ...
                      <span>Listing Filter</span>
                    </a>
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('filter_listing')}}">All Filters</a></li>
                      <li><a href="{{route('filter_feature_listing')}}">Features</a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_country_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('listing_country_table')}}">All Country</a></li>
                      <li><a href="{{route('listing_country')}}">Add New Country</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('listing_state_table')}}">All State</a></li>
                      <li><a href="{{route('listing_state')}}">Add New State</a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_city_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('listing_city_table')}}">All City</a></li>
                      <li><a href="{{route('listing_city')}}">Add New City</a></li>
                    </ul>
                  </li>
                  @endif 
                  @endif 
                  @if($admin->admin_service_expert_options==1 AND $footer->admin_expert_show)
                  <!-- Service Experts -->
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('expert_table')}}">All Experts</a></li>
                      <li><a href="{{route('expert')}}">Add New Expert</a></li>
                      <li><a href="{{route('lead_expert_table')}}">All Expert Leads</a></li>
                      <li><a href="{{route('General_expert_table')}}">All General leads</a></li>
                      <!-- <li><a href="admin-expert-admin-info.html">Service Expert Admin Info</a></li> -->
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('expert_category_table')}}">All Category</a></li>
                      <li><a href="{{route('expert_category')}}">Add New Category</a></li>
                      <li><a href="{{route('expert_category_position')}}">Homepage Category Order</a></li>
                      <li><a href="{{route('expert_sub_category_table')}}">All Sub category</a></li>
                      <li><a href="{{route('expert_sub_category')}}">Add new Sub Category</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      ...
                      <span>Expert State, Cities & Areas</span>
                    </a>
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('expert_state_table')}}">All Expert State</a></li>
                      <li><a href="{{route('expert_state')}}">Add New Expert State</a></li>
                      <li><a href="{{route('expert_city_table')}}">All Expert City</a></li>
                      <li><a href="{{route('expert_city')}}">Add New Expert City</a></li>
                      <li><a href="{{route('expert_area_table')}}">All Expert Areas</a></li>
                      <li><a href="{{route('expert_area')}}">Add New Expert Area</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      ...
                      <span>Accept Payment Modes</span>
                    </a>
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('expert_payment_table')}}">Payment Types</a></li>
                      <li><a href="{{route('expert_payment')}}">Add New Payment Type</a></li>
                    </ul>
                  </li>
                   @endif
                   @if($admin->admin_jobs_options==1 AND $footer->admin_job_show==1)
                  <!-- JOBS -->
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                      <span>JOBS</span>
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('job_table')}}">All Jobs</a></li>
                      <li><a href="{{route('job')}}">Add New Job Post</a></li>
                      <li><a href="{{route('job_seeker')}}">Job Seeker Details</a></li>
                      <li><a href="{{route('job_applied')}}">All Applied Jobs</a></li>
                      <li><a href="{{route('job_popular')}}">Home Page Premium Jobs</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('job_category_table')}}">All Category</a></li>
                      <li><a href="{{route('job_category')}}">Add New Category</a></li>
                      <li><a href="{{route('job_sub_category_table')}}">All Sub Category</a></li>
                      <li><a href="{{route('job_sub_category')}}">Add New Sub Category</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      ...
                      <span>Job Skill Set</span>
                    </a>
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('job_skill_table')}}">All Skill Set</a></li>
                      <li><a href="{{route('job_skill')}}">Add New Skill Set</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('job_state_table')}}">All Job State</a></li>
                      <li><a href="{{route('job_state')}}">Add New Job State</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('job_city_table')}}">All Job City</a></li>
                      <li><a href="{{route('job_city')}}">Add New Job City</a></li>
                    </ul>
                  </li>
                   @endif
                   @if($footer->admin_product_show==1)
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('product_table')}}">All Products</a></li>
                      <li><a href="{{route('product')}}">Add New Product</a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_product_category_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('product_category_table')}}">All Category</a></li>
                      <li><a href="{{route('product_category')}}">Add New Category</a></li>
                      <li><a href="{{route('product_sub_category_table')}}">All Sub Category</a></li>
                      <li><a href="{{route('product_sub_category')}}">Add New Sub Category</a></li>
                      <li><a href="{{route('product_child_category_table')}}">All Child Category</a></li>
                      <li><a href="{{route('product_child_category')}}">Add New Child Category</a></li>
                      <li><a href="{{route('product_brand_table')}}">All Brand</a></li>
                      <li><a href="{{route('product_brand')}}">Add New Brand</a></li>
                    </ul>
                  </li>
                   @endif
                   @endif
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      ...
                      <li><a href="{{route('shipping.create')}}">Add New Shipping</a></li>
                    </ul>
                  </li>
                   @if($admin->admin_order_options==1)
                  <!-- ORDERS -->
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                      <span>ORDERS</span>
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('order_table')}}">Order List</a></li>
                    </ul>
                  </li>
                  @endif
                  <!-- <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="admin-all-event-category.html">All Category</a></li>
                      <li><a href="admin-add-new-event-category.html">Add New Category</a></li>
                    </ul>
                  </li> -->

                  <!-- EVENTS -->
                  @if($admin->admin_event_options AND $footer->admin_event_show==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                      <span>EVENTS</span>
                    </a>
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('event_table')}}">All Events</a></li>
                      <li><a href="{{route('event')}}">Add New Event</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('event_cetagories_table')}}">All Category</a></li>
                      <li><a href="{{route('event_cetagory')}}">Add New Category</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('event_state_table')}}">All Event State</a></li>
                      <li><a href="{{route('event_state')}}">Add New Event State</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('event_city_table')}}">All Event City</a></li>
                      <li><a href="{{route('event_city')}}">Add New Event City</a></li>
                    </ul>
                  </li>
                   @endif
                   @if($admin->admin_blog_options==1 AND $footer->admin_blog_show==1)
                  <!-- BLOGS -->
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                      <span>BLOGS</span>
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('blog_table')}}">All Blogs</a></li>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      ...
                      <span>Coupon and Deals</span>
                    </a>
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('coupon_table')}}">All Coupons</a></li>
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('category_table')}}">All Category</a></li>
                      <li><a href="{{route('category')}}">Add New Category</a></li>
                      <li><a href="{{route('sub_category_table')}}">All Sub Category</a></li>
                      <li><a href="{{route('sub_category')}}">Add New Sub Category</a></li>
                      <li><a href="{{route('child_category_table')}}">All Child Category</a></li>
                      <li><a href="{{route('child_category')}}">Add New Child Category</a></li>
                      <li><a href="{{route('brand_table')}}">All Brand</a></li>
                      <li><a href="{{route('brand')}}">Add New Brand</a></li>
                    </ul>
                  </li>
                   @endif
                   @endif
                   @if($admin->admin_news_options==1 AND $footer->admin_news_show)
                  <!-- NEWS & MAGAZINES -->
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('news_table')}}">All News</a></li>
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('news_category_table')}}">All Category</a></li>
                      <li><a href="{{route('news_category')}}">Add New Category</a></li>
                      <li><a href="{{route('news_category_position')}}">Category Meny Order</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      ...
                      <span>News Home Page</span>
                    </a>
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('news_trend')}}">Trending Posts</a></li>
                      <li><a href="{{route('news_trend_position')}}">Trending posts menu order</a></li>
                      <li><a href="{{route('news_slider')}}">Slider Posts</a></li>
                      <li><a href="{{route('news_slider_position')}}">Slider posts menu order</a></li>
                      <li><a href="{{route('social')}}">Social Media</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('subscriber')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('place_table')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('place_category_table')}}">All Categories</a></li>
                      <li><a href="{{route('place_category_position')}}">Category Menu Order</a></li>
                    </ul>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('place_request_table')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  @endif
                    @endif
                  <!-- WALLET & CREDITS -->
                 @if($admin->admin_wallet_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('wallet')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M9.07861 16.1355H14.8936" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('withdrew')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                      ...
                      @if($admin->admin_sub_admin_type==0)
                      <span>Withdrawal Request ALL</span>
                      @else
                  ...
                  @if($admin->admin_sub_admin_type>0)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('request')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('commission')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                   ...
                   @if($admin->admin_sub_admin_type==0)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('wallet_withdrew-tran')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                      <span>PRODUCT AFFILIATION & WALLET</span>
                    </a>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('product_wallet')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M9.07861 16.1355H14.8936" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('product_withdrew')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('product_withdrew-tran')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                   ...
                   @endif
                  <!-- Payments -->
                  @if($admin->admin_payment_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                      <span>PAYMENTS</span>
                    </a>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('all_payment')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  @endif
                  @if($admin->admin_invoice_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                    ...
                    <ul class="sidebar-submenu">
                      ...
                      <li><a href="{{route('send_invoice')}}">Send Invoice</a></li>
                      <li><a href="{{route('all_invoice')}}">Shared Invoices</a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_payment_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('plan_table')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('payment_gateway')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('ads_current_table')}}">Current Ads</a></li>
                      <li><a href="{{route('ads')}}">Create new Ads</a></li>
                      <li><a href="{{route('ads_request_table')}}">Ad Request & Enquiry</a></li>
                      <li><a href="{{route('ads_pricing')}}">Ad Pricing</a></li>
                      <li><a href="{{route('google_ad')}}">Google AdSense</a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_sub_admin_type==0)
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('slider_table')}}">All Slider Images</a></li>
                      <li><a href="{{route('slider')}}">Add New Slider</a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_setting_options==1)
                  <!-- Settings -->
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                      <span>SETTINGS</span>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('setting')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('setting_all_page')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                      ...
                      <span>Page URL Setting</span>
                    </a>
                  </li>
                    @endif
                  <!-- Appearance -->
                  @if($admin->admin_appearance_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('website_logo')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M9.07861 16.1355H14.8936" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('color_setting')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M9.07861 16.1355H14.8936" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('feature')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M9.07861 16.1355H14.8936" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                      ...
                      <span>Features Enable & Disable</span>
                    </a>
                  </li>
                  <li class="sidebar-list">
                  ...
                  <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('top_section_table')}}">Top Section</a></li>
                      <li><a href="{{route('top_category_table')}}">Choose Category</a></li>
                      <li><a href="{{route('trend_category_table')}}">Choose Trending Category</a></li>
                      <li><a href="{{route('popular_business_table')}}">Popular Business</a></li>
                      <li><a href="{{route('top_service_table')}}">Top Services</a></li>
                      <li><a href="{{route('top_event_table')}}">Feature Events</a></li>
                      <!-- <li><a href="admin-home-page-template.html">Home page template</a></li> -->
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_text_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('text_change')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                      ...
                      <span>All Text Changes</span>
                    </a>
                  </li>
                  @endif
                  @if($admin->admin_footer_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('footer')}}">Footer CMS</a></li>
                      <li><a href="{{route('popular_tag_table')}}">Footer Popular Tags</a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_dummy_image_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('dummy_image')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                      ...
                      <span>Dummy Images</span>
                    </a>
                  </li>
                  @endif
                  @if($admin->admin_mail_template_options==1)
                  <!-- <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="admin-all-mail.html">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  @if($admin->admin_sub_admin_type==0)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="{{route('Social_media')}}">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  @if($admin->admin_feedback_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('feedback_table')}}">All Feedbacks</a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_notification_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('notification_table')}}"> All Notifications</a></li>
                      <li><a href="{{route('notification')}}"> Create New Notofication </a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_import_options==1)
                  <!-- <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                  ...
                  @endif
                  @if($admin->admin_sub_admin_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                    ...
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('sub_admin_table')}}"> All Sub Admins</a></li>
                      <li><a href="{{route('sub_admin')}}"> Create Sub Admin</a></li>
                    </ul>
                  </li>
                  @endif
                  @if($admin->admin_sub_admin_type_options==1)
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title" href="javascript:;">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
                      ...
                      <span>Sub Admin Type</span>
                    </a>
                    <ul class="sidebar-submenu">
                      <li><a href="{{route('sub_admin_type_table')}}"> All Sub Admin Type</a></li>
                    </ul>
                  </li>
                  @endif
                  ...
                  <!-- <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav bg-light-primary" href="javascript:;">
                      <span>BIZBOOK TEMPLATE</span>
                    </a>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="admin-activation.html">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                  ...
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="admin-updates.html">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                      ...
                      <span>Bizbook updates</span>
                    </a>
                  </li>
                  <li class="sidebar-list">
                    <a class="sidebar-link sidebar-title link-nav" href="admin-security-updates.html">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                          <g> 
                            <path d="M15.596 15.6963H8.37598" stroke="#130F26" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                      ...
                      <span>Security & update News</span>
                    </a>
                  </li> -->
                ...
                <!--
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav" href="search.html">
                      ...
                      </svg><span>Search Website          </span></a>
                  </li>
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g> 
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12 footer-copyright text-center">
                <p class="mb-0">Copyright 2022 © Fototech Portal  </p>
              </div>
            </div>
          </div>
        </footer>
