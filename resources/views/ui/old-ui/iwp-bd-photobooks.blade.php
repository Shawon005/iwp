				...
				<div class="container sec-all-list-bre">
					<div class="row">
						...
						<ul>
							...
							<li> <a href="all-listing.html">Photobooks</a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="row">
							...
							<div class="filt-com lhs-cate">
								...
								<div class="dropdown">
									<select class="chosen-select">
										...
										<option value="1">Photobooks</option>
										<option value="15">Photostore</option>
										<option value="16">Digital Products</option>
										<option value="17">Pet shop</option>
										<option value="18">Hotel & Food</option>
										<option value="19">Wedding halls</option>
										<option selected value="10">Photobooks</option>
							...
							<div class="filt-com lhs-cate">
								...
								<div class="dropdown">
									<select class="chosen-select">
										...
										<option value="18">Hotel & Food</option>
										<option value="19">Wedding halls</option>
										<option selected value="10">Select states</option>
										<option value="8">Sports</option>
										<option value="7">Education</option>
										<option value="3">Transportation</option>
										<option value="6">Electricals</option>
							...
							<div class="filt-com lhs-cate">
								...
								<div class="dropdown">
									<select class="chosen-select">
										...
										<option value="18">Hotel & Food</option>
										<option value="19">Wedding halls</option>
										<option selected value="10">Select Cities</option>
										<option value="8">Sports</option>
										<option value="7">Education</option>
										<option value="3">Transportation</option>
										<option value="6">Electricals</option>
					...
					<div class="col-md-9">
						...
						<div class="ban-ati-com ads-all-list"> 
                            <a href="https://themeforest.net/item/bizbook-directory-listings-template/25391222"><span>Ad</span><img src="http://iwpdirectory.in/images/ads/28517c1b94496-97fe-4c70-99de-0bfa7725667c.jpg" alt="">
                            </a>
						</div>
						<div class="ban-ati-com ads-all-list"> 
                            <a href="https://themeforest.net/item/bizbook-directory-listings-template/25391222"><span>Ad</span><img src="http://iwpdirectory.in/images/ads/28517c1b94496-97fe-4c70-99de-0bfa7725667c.jpg" alt="">
