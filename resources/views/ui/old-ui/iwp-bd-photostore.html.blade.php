				...
				<div class="container sec-all-list-bre">
					<div class="row">
						...
						<ul>
							...
							<li> <a href="all-listing.html">photostore</a>
							</li>
						</ul>
					</div>
				</div>
								...
								<div class="near-ser-list top-ser-secti-prov">
									<ul>
										<li>
											<div class="near-bx">
												<div class="ne-1">
													<img src="http://iwpdirectory.in/images/listings/31545shiv-ajyothi.jpg">
												</div>
												<div class="ne-2">
													<h5>Shiva Chikkadapally,Hyder</h5>
									...
									<div class="eve-box">
										...
										<div class="al-img"> <span class="open-stat">open</span>
											<a href="listing-details.html">
                                                <img src="http://iwpdirectory.in/images/listings/31545shiv-ajyothi.jpg" alt="">
                                            </a>
										</div>
										<!---END LISTING IMAGE--->
										<!---LISTING NAME--->
										<div>
											<h4>
                                                <a href="listing-details.html">Shiva jyothi electronies</a>
