	...
	<section class=" ud">
		<div class="ud-inn">
			...
			<div class="ud-lhs">
				...
				<div class="ud-lhs-s2">
					<ul>
						...
						<li>
							<a href="db-promote.html" class="db-lact">
			...
			<div class="ud-cen">
				...
				<div class="ud-cen-s2">
					<h2>Promotions</h2>
					<a href="promote-business.html" class="db-tit-btn">Start new promotions</a>
						...
						<tbody>
							<tr>
								...
								<td><span class="db-list-ststus">Expired                                    </span>
									...
									<a href="promote-business.html?code=LIST394&&type=listing"> <span style="background-color: #4caf50;" class="db-list-ststus"> Activate                             </span>
									</a>
								</td>
								<td>
							...
							<tr>
								...
								<td><span class="db-list-ststus">Expired                                    </span>
									...
									<a href="promote-business.html?code=LIST393&&type=listing"> <span style="background-color: #4caf50;" class="db-list-ststus"> Activate                             </span>
									</a>
								</td>
								<td>
							...
							<tr>
								...
								<td><span class="db-list-ststus">Expired                                    </span>
									...
									<a href="promote-business.html?code=LIST247&&type=listing"> <span style="background-color: #4caf50;" class="db-list-ststus"> Activate                             </span>
									</a>
								</td>
								<td>
