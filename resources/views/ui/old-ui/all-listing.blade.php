			...
			<div class="all-list-bre">
				<div class="container sec-all-list-bre">
					<div class="row">
						<h1>Real Estate</h1>
						<ul>
							<li><a href="{{route('profile')}}">Home</a>
							</li>
				...
				<div class="row">
								...
								<div class="near-ser-list top-ser-secti-prov">
									<ul>
										<li>
											<div class="near-bx">
												<div class="ne-1">
													<img src="{{asset('')}}frontend/images/services/1.jpg">
												</div>
												<div class="ne-2">
												...
												<a href="{{route('listing-details')}}"></a>
											</div>
										</li>
										<li>
											<div class="near-bx">
												<div class="ne-1">
													<img src="{{asset('')}}frontend/images/services/12.jpeg">
												</div>
												<div class="ne-2">
										...
										<li>
											<div class="near-bx">
												<div class="ne-1">
													<img src="{{asset('')}}frontend/images/services/13.jpg">
												</div>
												<div class="ne-2">
										...
										<li>
											<div class="near-bx">
												<div class="ne-1">
													<img src="{{asset('')}}frontend/images/services/14.jpg">
												</div>
												<div class="ne-2">
										...
										<li>
											<div class="near-bx">
												<div class="ne-1">
													<img src="{{asset('')}}frontend/images/services/20.jpeg">
												</div>
												<div class="ne-2">
							...
							<div class="filt-com lhs-ads">
								<ul>
									<li>
										<div class="ads-box">
											<a href=""> <span>Ad</span>
												<img src="{{asset('')}}frontend/images/ads/ads1.jpg" alt="">
											</a>
										</div>
									</li>
									<!--                                    <li>-->
					...
					<div class="col-md-9">
						...
						<div class="ban-ati-com ads-all-list"> 
                            <a href="http://iwpdirectory.in/images/ads/28517c1b94496-97fe-4c70-99de-0bfa7725667c.jpg"><span>Ad</span><img src="{{asset('')}}frontend/images/ads/1.png" alt="">
                            </a>
						</div>
						<!--ADS-->
						<!-- Loader Image -->
						...
						<div class="all-list-sh all-listing-total">
							<ul>
								<li>
									<div class="eve-box">
										...
										<div>
											<h4>
                                                <a href="{{route('listing-details')}}">Rolexo Villas in California</a>
                                                <i class="li-veri"><img src="{{asset('')}}frontend/images/icon/svg/verified.png" alt=""></i>
                                            </h4>
											<label class="rat"> 
                                                <i class="material-icons">star</i>
												<i class="material-icons">star</i>
                                        ...
                                        <i class="l-like sav-act"><img src="{{asset('')}}frontend/images/icon/svg/like.svg" alt=""></i></span>
										<!---END SAVE--->
									</div>
								</li>
                                <li>
									<div class="eve-box">
										...
										<div class="al-img"> <span class="open-stat">open</span>
											<a href="{{route('listing-details')}}">
                                                <img src="{{asset('')}}frontend/images/services/24.jpg" alt="">
                                            </a>
										</div>
										<!---END LISTING IMAGE--->
										<!---LISTING NAME--->
										<div>
											<h4>
                                                <a href="{{route('listing-details')}}">Village food street</a>
                                                <i class="li-veri"><img src="{{asset('')}}frontend/images/icon/svg/verified.png" alt=""></i>
                                            </h4>
											<label class="rat"> 
                                                <i class="material-icons">star</i>
                                ...
                                <li>
									<div class="eve-box">
										...
										<div>
											<h4>
                                                <a href="{{route('listing-details')}}">Honey 2 massage & facial </a>
                                                <i class="li-veri"><img src="{{asset('')}}frontend/images/icon/svg/verified.png" alt=""></i>
                                            </h4>
											<label class="rat"> 
                                                <i class="material-icons">star</i>
                                ...
                                <li>
									<div class="eve-box">
										...
										<div>
											<h4>
                                                <a href="{{route('listing-details')}}">Orange pet shops</a>
                                                <i class="li-veri"><img src="{{asset('')}}frontend/images/icon/svg/verified.png" alt=""></i>
                                            </h4>
											<label class="rat"> 
                                                <i class="material-icons">star</i>
                                ...
                                <li>
									<div class="eve-box">
										...
										<div>
											<h4>
                                                <a href="{{route('listing-details')}}">Ocean blue interier designs</a>
                                                <i class="li-veri"><img src="{{asset('')}}frontend/images/icon/svg/verified.png" alt=""></i>
                                            </h4>
											<label class="rat"> 
                                                <i class="material-icons">star</i>
                                ...
                                <li>
									<div class="eve-box">
										...
										<div>
											<h4>
                                                <a href="{{route('listing-details')}}">Packy hospital & Health care</a>
                                                <i class="li-veri"><img src="{{asset('')}}frontend/images/icon/svg/verified.png" alt=""></i>
                                            </h4>
											<label class="rat"> 
                                                <i class="material-icons">star</i>
                                ...
                                <li>
									<div class="eve-box">
										...
										<div>
											<h4>
                                                <a href="{{route('listing-details')}}">Maching wedding matrimoney</a>
                                                <i class="li-veri"><img src="{{asset('')}}frontend/images/icon/svg/verified.png" alt=""></i>
                                            </h4>
											<label class="rat"> 
                                                <i class="material-icons">star</i>
                                ...
                                <li>
									<div class="eve-box">
										...
										<div>
											<h4>
                                                <a href="{{route('listing-details')}}">The Royal Blue Resort & Hotels</a>
                                                <i class="li-veri"><img src="{{asset('')}}frontend/images/icon/svg/verified.png" alt=""></i>
                                            </h4>
											<label class="rat"> 
                                                <i class="material-icons">star</i>
                                ...
                                <li>
									<div class="eve-box">
										...
										<div>
											<h4>
                                                <a href="{{route('listing-details')}}">Original bike services</a>
                                                <i class="li-veri"><img src="{{asset('')}}frontend/images/icon/svg/verified.png" alt=""></i>
                                            </h4>
											<label class="rat"> 
                                                <i class="material-icons">star</i>
							...
							<!--ADS-->
							<div class="ban-ati-com ads-all-list"> 
                                <a href="https://themeforest.net/item/bizbook-directory-listings-template/25391222"><span>Ad</span><img src="{{asset('')}}frontend/images/ads/3.png" alt=""></a>
							</div>
							<!--ADS-->
						</div>
					</div>
