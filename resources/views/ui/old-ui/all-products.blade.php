						...
						<div class="all-list-sh all-product-total">
							<ul>
								<li>
									<div class="all-pro-box">
										<div class="all-pro-img">
											<img src="{{asset('')}}frontend/images/products/1.jpg">
										</div>
										...
										<a href="{{route('product-details')}}" class="pro-view-full"></a>
									</div>
								</li>
                                <li>
									<div class="all-pro-box">
										<div class="all-pro-img">
											<img src="{{asset('')}}frontend/images/products/2.jpeg">
										</div>
										<div class="all-pro-txt">
											<h4>Audi q3</h4>
											<span class="pri"><b class="pro-off">$32400</b>0% off </span>
                                ...
                                <li>
									<div class="all-pro-box">
										<div class="all-pro-img">
											<img src="{{asset('')}}frontend/images/products/4.jpeg">
										</div>
										<div class="all-pro-txt">
											<h4>Audi q3</h4>
											<span class="pri"><b class="pro-off">$32400</b>0% off </span>
                                ...
                                <li>
									<div class="all-pro-box">
										<div class="all-pro-img">
											<img src="{{asset('')}}frontend/images/products/5.jpeg">
										</div>
										<div class="all-pro-txt">
											<h4>Audi q3</h4>
											<span class="pri"><b class="pro-off">$32400</b>0% off </span>
                                ...
                                <li>
									<div class="all-pro-box">
										<div class="all-pro-img">
											<img src="{{asset('')}}frontend/images/products/6.jpeg">
										</div>
										<div class="all-pro-txt">
											<h4>Audi q3</h4>
											<span class="pri"><b class="pro-off">$32400</b>0% off </span>
                                ...
                                <li>
									<div class="all-pro-box">
										<div class="all-pro-img">
											<img src="{{asset('')}}frontend/images/products/7.jpeg">
										</div>
										<div class="all-pro-txt">
											<h4>Audi q3</h4>
											<span class="pri"><b class="pro-off">$32400</b>0% off </span>
                                ...
                                <li>
									<div class="all-pro-box">
										<div class="all-pro-img">
											<img src="{{asset('')}}frontend/images/products/7.jpg">
										</div>
										<div class="all-pro-txt">
											<h4>Audi q3</h4>
											<span class="pri"><b class="pro-off">$32400</b>0% off </span>
                                ...
                                <li>
									<div class="all-pro-box">
										<div class="all-pro-img">
											<img src="{{asset('')}}frontend/images/products/8.jpg">
										</div>
										<div class="all-pro-txt">
											<h4>Audi q3</h4>
											<span class="pri"><b class="pro-off">$32400</b>0% off </span>
