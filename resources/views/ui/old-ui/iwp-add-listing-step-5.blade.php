				...
				<div class="add-list-ste">
					<div class="add-list-ste-inn">
				    	<ul>
							...
							<li>
								<a href="#"class="act"> <span>Step 5</span>
									<b>Other</b>
								</a>
							</li>
							<li>
				...
				<div class="login-main add-list">
					...
					<div class="log">
						<div class="login add-lis-oth">
							...
							<form action="{{route('user_listing_store')}}" class="listing_form" id="listing_form_5" name="listing_form_5" method="post" enctype="multipart/form-data">
							@csrf
