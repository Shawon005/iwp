		...
		<div class="container">
			<div class="row">
				<div class="login-main add-list">
					<div class="log-bor">&nbsp;</div> <span class="steps">ADD NEW COUPON</span>
					<div class="log">
						<div class="login">
							...
							<form name="coupon_form" id="coupon_form" enctype="multipart/form-data" method="post" action="coupon_insert.html" class="listing_form_1">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<input id="coupon_name" type="text" class="form-control" name="coupon_name" placeholder="Coupon name" required>
										</div>
									</div>
								</div>
								<!--FILED END-->
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<input type="text" class="form-control" name="offer_code" placeholder="Offer code" required>
										</div>
									</div>
								</div>
								<!--FILED END-->
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<select onChange="getSubCategory(this.value);" name="category" id="category" class="chosen-select form-control">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<!-- <label for="job_category">Job Category</label> -->
											<select onChange="getSubCategory(this.value);" name="sub_category" id="sub_category" class="chosen-select form-control">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<!-- <label for="job_category">Job Category</label> -->
											<select onChange="getSubCategory(this.value);" name="child_category" id="child_category" class="chosen-select form-control">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<!-- <label for="job_category">Job Category</label> -->
											<select onChange="getSubCategory(this.value);" name="brand" id="brand" class="chosen-select form-control">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<input id="website_link" type="text" class="form-control" name="website_link" placeholder="Website link(if online offer)">
										</div>
									</div>
								</div>
								<!--FILED END-->
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input id="brand_logo" type="file" required="required" name="brand_logo" class="form-control" placeholder="Offer image">
										</div>
									</div>
								</div>
								<!--FILED END-->
