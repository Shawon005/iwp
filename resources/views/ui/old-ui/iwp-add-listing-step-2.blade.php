				...
				<div class="add-list-ste">
					<div class="add-list-ste-inn">
					    <ul>
							...
							<li>
								<a href="#"class="act"> <span>Step 2</span>
									<b>Services</b>
								</a>
							</li>
							<li>
				...
				<div class="login-main add-list add-list-ser">
					...
					<div class="log">
						<div class="login">
							...
							<form action="{{route('user_listing_store')}}" class="listing_form_2" id="listing_form_2" name="listing_form_2" method="post" enctype="multipart/form-data">
								 @csrf
								...
								<input id="listing_description" name="listing_description" type="hidden" value="<p>asaDasd</p>" required="required" class="validate">
