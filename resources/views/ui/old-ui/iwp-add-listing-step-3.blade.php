				...
				<div class="add-list-ste">
					<div class="add-list-ste-inn">
					    <ul>
							...
							<li>
								<a href="#"class="act"> <span>Step 3</span>
									<b>offers</b>
								</a>
							</li>
							<li>
				...
				<div class="login-main add-list">
					...
					<div class="log">
						<div class="login add-list-off">
							...
							<form action="{{route('user_listing_store')}}" class="listing_form_3" id="listing_form_3" name="listing_form_3" method="post" enctype="multipart/form-data">
								@csrf
