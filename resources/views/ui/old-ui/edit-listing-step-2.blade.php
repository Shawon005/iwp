				...
				<div class="add-list-ste">
					<div class="add-list-ste-inn">
					    <ul>
							...
							<li>
								<a href="{{route('edit_listing_step_1',['id'=>$listing->listing_id,'step'=>2])}}" class="act"> <span>Step 2</span>
									<b>Services</b>
								</a>
							</li>
							<li>
				...
				<div class="login-main add-list add-list-ser">
					...
					<div class="log">
						<div class="login">
							...
							<form action="{{route('user_listing_update',['id'=>$listing->listing_id])}}" class="listing_form_2" id="listing_form_2" name="listing_form_2" method="post" enctype="multipart/form-data">
								@csrf
								<input name="step" type="text" class="d-none" value="2">
							   <input id="listing_name" name="listing_name" type="hidden" value="qwerqw" required="required" class="validate">
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													...
													<input type="text" name="service_id[]" class="form-control"  value="{{$service}}"placeholder="Ex: Plumbile">
												</div>
											</div>
											<div class="col-md-6">
												<div class="form-group">
								...
								<div class="row">
									<div class="col-md-6">
										<a href="{{route('edit_listing_step_1',['id'=>$listing->listing_id,'step'=>1])}}">
									...
									<div class="col-md-12"> <a href="{{route('edit_listing_step_1',['id'=>$listing->listing_id,'step'=>3])}}" class="skip">Skip this                                        &gt;&gt;</a>
									</div>
								</div>
								<!--FILED END-->
							</form>
