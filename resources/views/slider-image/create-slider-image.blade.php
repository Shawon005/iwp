              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    <form class="row needs-validation" action="{{route('slider_store')}}" method="Post" enctype="multipart/form-data">
                        @csrf
                      <div class="col-sm-12">
                        <div class="mb-3">
                          <label for="choose_slider_image">Choose Slider Image</label>
                          <input class="form-control" id="choose_slider_image" type="file" name="slider_photo" placeholder="" required="">
                          <div class="valid-feedback">Looks good!</div>
                        </div>
                        <div class="mb-3">
                          <!-- <label>Slider External Link<label> -->
                          <textarea class="form-control" id="exampleFormControlTextarea4"placeholder="Slider External Link"  name="slider_link"rows="3"></textarea>
                        </div>
                      </div>
