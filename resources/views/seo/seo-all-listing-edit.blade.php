...
@section('content')
        ...
        <div class="page-body">
            ...
            <div class="page-title">
              <div class="row">
                <div class="col-12 col-sm-6">
                  <h3>Edit Listing SEO options</h3>
                </div>
          ...
          <div class="container-fluid">
            ...
            <form action="{{route('all_listing_update',['id'=>$page->listing_id])}}"method="POST">
                @csrf
              <div class="row">
                          ...
                          <div class="tab-pane fade active show" id="pills-created" role="tabpanel" aria-labelledby="pills-created-tab">
                            <div class="card mb-0">
                              <div class="card-body pb-0">
                                ...
                                <div class="mb-3">
                                  <input class="form-control" id="page_name" type="text" name="page_name" readonly value="{{$page->listing_name}}" placeholder="Page name" required="">
                                  ...
                                  <div class="panel panel-default border">
                                    ...
                                    <div class="panel-body">
                                      <div class=" p-3">
                                        ...
                                        <input class="form-control" id="page_title" type="text" name="page_seo_title" value="{{$page->seo_title}}"placeholder="" required="">
                                        <div class="valid-feedback">Looks good!</div>
                                      </div>
                                      <div class=" p-3">
                                        <label for="page_keywords">Page keywords</label>
                                        <input class="form-control" id="page_keywords" type="text" name="page_seo_keyword"value="{{$page->seo_keywords}}" placeholder="" required="">
                                        <div class="valid-feedback">Looks good!</div>
                                      </div>
                                      <div class="mb-3 p-3">
                                        <label for="page_descriptions">Page descriptions</label>
                                        <input class="form-control" id="page_descriptions" type="text" name="page_seo_description" value="{{$page->seo_description}}"placeholder="Contact no" required="">
                                        <div class="valid-feedback">Looks good!</div>
                                      </div>
                                    </div>
                                  </div>
