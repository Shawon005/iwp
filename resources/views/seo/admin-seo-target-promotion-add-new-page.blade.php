...
@section('content')
        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            ...
            <form action="{{route('seo_target_Store')}}"method="POST">
                               @csrf
              <div class="row">
                          ...
                          <div class="tab-pane fade active show" id="pills-created" role="tabpanel" aria-labelledby="pills-created-tab">
                            ...
                            <div class="card mb-0">
                              <div class="card-body pb-0">
                                ...
                                <div class="mb-3">
                                  <input class="form-control" id="page_name" type="text" name="page_name" value="" placeholder="Page name" required="">
                                  ...
                                  <div class="panel panel-default border">
                                    ...
                                    <div class="panel-body">
                                      ...
                                      <div class="mb-3 p-3">
                                        ...
                                        <input class="form-control" id="page_descriptions" type="text" name="page_seo_description" placeholder="Contact no" required="">
                                        <div class="valid-feedback">Looks good!</div>
                                      </div>
                                    </div>
                                  </div>
