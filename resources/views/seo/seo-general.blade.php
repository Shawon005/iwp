        ...
        @if(session('message'))
          ...
          <div class="card p-1 container-fluid">
            <div class="page-title">
              <h3 class="text-center" >All Page</h3>
              <div class="row">
                <div class="col-12 col-sm-6">
                
                  <h4>General Promotion Pages</h4>
                </div>

                <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('admin/dashboard')}}"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item"><a href="{{route('seo_general')}}">ADD NEW</a></li>
              </div>
            </div>
          </div>
          @php $listing_category=sub('vv_pages','page_type',2); $no=1; @endphp
                      ...
                      <table class="table table-bordered " id="basic-10" style="width: 100%; font-size:12px;white-space: nowrap; ">
                       ...
                       @foreach($listing_category as $user)
                        <tr>   
                           ...
                           <td> <a class="btn-sm btn-info" href="{{route('seo_general_edit',['id'=>$user->page_id])}}">Edit </a></td>
                           <td>
                           @method('delete')
