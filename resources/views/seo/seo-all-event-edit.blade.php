...
@section('content')
        ...
        <div class="page-body">
          ...
          <div class="container-fluid">
            ...
            <form action="{{route('all_event_update',['id'=>$page->event_id])}}"method="POST">
                @csrf
              <div class="row">
                          ...
                          <div class="tab-pane fade active show" id="pills-created" role="tabpanel" aria-labelledby="pills-created-tab">
                            <div class="card mb-0">
                              <div class="card-body pb-0">
                                ...
                                <div class="mb-3">
                                  <input class="form-control" id="page_name" type="text" name="page_name" readonly value="{{$page->event_name}}" placeholder="Page name" required="">
