              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('add_seo_ebook')}}">ADD NEW</a></li>
              </div>
            </div>
          </div>
          @php $listing_category=sub('vv_pages','page_type',3); $no=1; @endphp   
                      ...
                      <table class="table table-bordered " id="basic-10" style="width: 100%; font-size:12px;white-space: nowrap; ">
                       ...
                       @foreach($listing_category as $user)
                        <tr>   
                           ...
                           <td> <a class="btn-sm btn-info" href="{{route('seo_ebook_edit',['id'=>$user->page_id])}}">Edit </a></td>
                           <td>
                           @method('delete')
