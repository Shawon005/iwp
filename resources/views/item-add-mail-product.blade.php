            ...
            <tr>
                <td>
                    <table style="background: #fff;width:500px;padding: 20px;margin: 0 auto;box-shadow: 0px 1px 10px 13px #2d313703;border-radius: 8px;font-weight: 500;">
                        ...
                        <tr>
                            <td><strong> {{$data['add']}} name:</strong> <span contenteditable="false"></span></td>
                        </tr>     
                        <tr>
                            <td><strong>Product Price :</strong> <span contenteditable="false">{{$data['price']}}</span></td>
                        </tr> 
                        <tr>
                            <td> <span contenteditable="false"><a href="" ><strong>Product Link :</strong></a> </span></td>
                        </tr>
                        <tr><td>&nbsp;</td></tr>    
                        <tr>
