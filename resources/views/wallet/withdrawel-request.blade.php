...
<div class="page-body">
  ...
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="{{route('withdrew')}}">All</a>
  </li>
  <li class="nav-item">
    <a class="nav-link"   href="{{route('wallet_paddind')}}">Pending</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="{{route('wallet_approve')}}">Approved</a>
  </li>
  <li class="nav-item">
    <a class="nav-link"  href="{{route('wallet_rejected')}}">Rejected</a>
  </li>
  <li class="nav-item">
    <a class="nav-link"data-bs-toggle="" href="{{route('wallet_sent')}}">Sent</a>
  </li>
</ul>
                      <table class="table table-bordered table-light " id="basic-10" style="width: 100%; text-align: left; font-size:12px;white-space: nowrap; ">
                       ...
                       <tbody>
                        ...
                        <tr>
                           ...
                           <td> <img   src="{{asset('/storage/file/'.Nam('vv_users','user_id',$user->user_id,'profile_image'))}}"width="50" height="60" class="rounded-circle"alt="">
                          ...
                          @else
                          {{($user->remarks==null)?'N/A':$user->remarks}}
                          @endif
                          </td>
                        </tr>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                  <form  action="{{route('wallet_status',['id'=>$user->wallet_transaction_id])}}" method="post">
                                    @csrf
                                    <div class="mb-3">
