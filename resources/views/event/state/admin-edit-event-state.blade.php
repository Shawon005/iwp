              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    <form class="row needs-validation" action="{{route('event_state_update',['id'=>$state[0]->state_id])}}" method="Post">
                      @csrf
                      ...
                      <div class="col-sm-12">
                            ...
                            <select class="js-example-basic-single col-sm-12" name="country_id" id="country"> 
                                ...
                                <option value="">Select Country</option>
                                  @foreach($country as $user):
                                    @if($state[0]->country_id == $user->country_id)
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control" id="event_state_name" type="text" name="state_name" placeholder="Event State name*" required="" value="{{$state[0]->state_name}}">
