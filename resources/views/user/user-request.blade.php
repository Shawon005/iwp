        ...
        @if(session('message'))
          ...
          <div class="card p-1 container-fluid" style="">
            <div class="page-title">
              <h3 class="text-center" >Users Request</h3>
              <div class="row">
                <div class="col-12 col-sm-6">
                  <h4>All Users Request {{sprintf("%02d",count($users))}}</h4>
                </div>
                      ...
                      <table class="table table-bordered  " id="basic-10" style="width: 100%; text-align: left; font-size:12px;white-space: nowrap; ">
                       ...
                       <tbody>
                        ...
                        <tr>
                           ...
                           <td></td>
                           <td class="approve" ><a class="btn-sm btn-warning" href=""onclick="approve({{$user->user_id}})">Approve </a></td>
