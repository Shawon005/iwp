            ...
            <div class="page-title">
              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  <h4>New Users {{sprintf("%02d",count($users))}}</h4>
                </div>
                <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                      ...
                      <table class="table table-bordered " id="basic-10" style="width: 100%; text-align: left; font-size:12px;white-space: nowrap; ">
                       ...
                       <tbody>
                        ...
                        <tr>
                           ...
                           <div class="row">
                              <div class="col-3">
                                <img src="{{asset('/storage/file/'.$user->profile_image)}}"width="50" height="60" style="border-radius:50%" alt="">
                              </div>
                              <div class="col-4">
                           ...
                           <td>{{dateFormatConverter(($user->user_cdt.' + 1 years'))}}</td>
