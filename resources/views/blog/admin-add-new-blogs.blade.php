              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    <form class="row needs-validation" novalidate=""action="{{route('blog_store')}}" method="Post"enctype="multipart/form-data">
                      @csrf
                    <div class="col-sm-12">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control" id="post_name" type="text" name="blog_name" placeholder="Post name*" required="">
                          <div class="valid-feedback">Looks good!</div>
                        </div>
                        <div class="mb-3">
                          <label>Post Details</label>
                          <textarea id="editor1" cols="10" rows="2"name="blog_description"></textarea>
                        </div>
                        <div class="mb-3">
                          <label for="banner_image">Choose Banner Image</label>
                          <input class="form-control" id="banner_image" type="file" name="blog_image[]" placeholder="" required=""multiple="multiple">
                          <div class="valid-feedback">Looks good!</div>
                        </div>
                        <div class="mb-3">
                          <div class="d-inline">
