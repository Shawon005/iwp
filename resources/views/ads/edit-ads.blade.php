              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    <form class="row needs-validation"action="{{route('ads_update',['id'=>$ads->all_ads_enquiry_id ])}}" method="Post" enctype="multipart/form-data" novalidate="">
                        @csrf
                      <div class="col-sm-12">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          <div class="col-form-label"> 
                            ...
                            <select class="js-example-placeholder-multiple col-sm-12" id="cost1" name="position_id">
                                 <option value=" ">Choose Position*</option>
                                 @foreach($position as $user):
                                  @if($ads->all_ads_price_id==$user->all_ads_price_id)
                                 <option value="{{$user->all_ads_price_id}}"selected>{{$user->ad_price_name}}({{$user->ad_price_cost}}Rs/Per Day)</option>
                                 @else
                        ...
                        <div class="mb-3">
                          ...
                          <!-- <div class="col-xl-5 col-sm-9"> -->
                            <div class="input-group">
                              <input class=" form-control digits" type="date" id="start_date"name="start_date"value="{{$ads->ad_start_date}}"onfocusout="func()"data-language="en">
                            </div>
                          <!-- </div> -->
                        </div>
                        <div class="mb-3">
                          ...
                          <!-- <div class="col-xl-5 col-sm-9"> -->
                            <div class="input-group">
                              <input class="form-control digits" type="date"id="end_date" value="{{$ads->ad_end_date}}"onfocusout="func()"name="end_date"data-language="en">
                            </div>
                          <!-- </div> -->
                        </div>
                        <div class="mb-3">
                          <label for="choose_ad_image">Choose Ad Image</label>
                          <input class="form-control" id="choose_ad_image" type="file" name="choose_ad_image" placeholder="" >
                          <div class="valid-feedback">Looks good!</div>
                        </div>
                       
                        <div class="mb-3">
                          <textarea class="form-control" id="exampleFormControlTextarea4" rows="3"name="link"placeholder="Advertisement External Link">{{$ads->ad_link}}</textarea>
                        </div>
                        <div class="row">
                          <div class="col-sm-3">
...
<script>
    ...
    function val(cost)
    {
        alert(cost);
     par_cost=cost;
     document.getElementById("cost").innerHTML="Rs:"+par_cost;
    }
...
//   window.alert("total_day")
         ...
         // alert(total_day/(60*60*24));
          ...
          document.getElementById("cost").innerHTML=par_cost;
