...
<html lang="en">
  <head>
    ...
    <title>Fototech Portal|Admin</title>
    <!-- Google font-->
        ...
        <div class="row">
          ...
          @if(Session::get('massage'))
            ...
            <div class="login-card">
              <form class="theme-form login-form"  action="{{route('admin_forget_password')}}" method="Post">
                @csrf
              
                <h4>Forget Password</h4>
                <h6>Welcome back! Enter You Email . </h6>
              
               
                <div class="form-group">
                  <label>Email Address</label>
                  <div class="input-group"><span class="input-group-text"><i class="icon-email"></i></span>
                    <input class="form-control" type="email" required="" placeholder="Enter Email"name="email_id">
                  </div>
                </div>
