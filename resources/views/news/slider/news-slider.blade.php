        ...
        @if(session('message'))
          ...
          <div class="card p-1 container-fluid" >
            <div class="page-title">
              <h3 class="text-center" >News Slider Posts</h3>
              <div class="row">
                <div class="col-12 col-sm-6">
                  <h4>All News Slider Posts</h4>
                </div>
                      ...
                      <table class="table table-bordered " id="" style="width: 100%; font-size:12px;white-space: nowrap; ">
                       ...
                       <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{$user->news_slider_pos_id}}</td>
                           <td>{{Nam('vv_news','news_id',$user->news_id,'news_title')}}</td>
                          <td>
                            <a class="btn-sm btn-info" href="{{route('news_slider_edit',['id'=>$user->news_slider_id])}}">Edit </a> 
                          </td>
                        </tr>
                        @endforeach
                       </tbody>
