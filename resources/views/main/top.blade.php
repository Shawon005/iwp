									...
									<div class="container">
										<div class="row"> <i class="material-icons clopme">close</i>
												...
												<ul>
													<li>
														<a href="{{route('all-category')}}" class="act">
															<img src="{{asset('')}}frontend/images/icon/shop.png">Photo Directory</a>
													</li>
													<li>
														<a href="{{route('events')}}">
											...
											<div class="dir-home-nav-bot">
												<ul>
													<li>A few reasons you’ll love Online Business Directory <span>Call us on: +914040112038</span> 
													</li>
											...
											<ul>
												...
												<li>
													<a href="db-{{route('all-listing')}}" class="">
														<img src="{{asset('')}}frontend/images/icon/shop.png" alt="" />photo directory</a>
												</li>
												<li>
