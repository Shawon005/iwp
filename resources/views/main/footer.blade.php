...
<section>
	...
	<section class=" wed-hom-footer">
		<div class="container">
			<div class="row foot-supp">
				<h2><span>Free support:</span> {{$footer->footer_mobile}} &nbsp;&nbsp;|&nbsp;&nbsp; <span>Email:</span> fototechportal@gmail.com</h2>
			</div>
			...
			<div class="row wed-foot-link-1">
				<div class="col-md-4">
					...
					<p>Phone: <a href="tel:+01 5426 24400">+914040112038</a>
					</p>
					<p>Email: <a href="mailto:rn53themes@gmail.com">fototechportal@gmail.com</a>
					</p>
				</div>
	...
	<section>
		<div class="cr">
			<div class="container">
				<div class="row">
					<p>Copyright © 2011-2030 <a href="https://rn53themes.net/" target="_blank">Fototech India</a>. Proudly powered by <a href="https://rn53themes.net/" target="_blank">fototechportal.com</a>
					</p>
				</div>
			</div>
		</div>
