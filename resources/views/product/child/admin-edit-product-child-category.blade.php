              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    <form class="row needs-validation" action="{{route('product_child_category_update',['id'=>$child_category->child_category_id])}}"method="post">
                      @csrf
                    <div class="col-sm-12">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          <div class="col-form-label"> 
                            ...
                            <select class="js-example-placeholder-multiple col-sm-12"name="sub_category_id"id="sub_ategory_id">
