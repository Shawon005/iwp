        ...
        @if(session('message'))
          ...
          <div class="card p-1 container-fluid" >
            <div class="page-title">
              <h3 class="text-center" >Product Child Category</h3>
              <div class="row">
                <div class="col-12 col-sm-6">
                  <h4>All Product child Category</h4>
                </div>

                <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('admin/dashboard')}}"><i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item"><a href="{{route('product_child_category')}}">ADD NEW PRODUCT CHILD CATEGORY</a></li>
              </div>
            </div>
          </div>
          ...
          <div class="container-fluid table-responsive">
                      <table class="table table-bordered " id="basic-10" style="width: 100%; text-align: center; font-size:12px;white-space: nowrap; ">
                        <thead>
                          <tr>
                            <th>NO</th>
                            <th>Product Child Category Name</th>
                       ...
                       <tbody>
                        ...
                        <tr>
                           ...
                           <td>{{CountCol('vv_products','child_category_id',$user->child_category_id)}}</td>
                          <td><a class="btn-sm btn-primary" href="#">Show </a>
                            | <a class="btn-sm btn-info" href="{{route('product_child_category_edit',['id'=>$user->child_category_id])}}">Edit </a> |
                          
                          @method('delete')
                          <a onclick="return confirm('Are you want to delete')"  class="btn-sm btn-danger" href="{{route('product_child_category_delete',['id'=>$user->child_category_id])}}">Delete </a> 
                          </td>
                        </tr>
                        @endforeach
                       </tbody>
