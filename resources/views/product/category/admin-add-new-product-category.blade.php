              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    <form class="row needs-validation" action="{{route('product_category_store')}}"method="post"enctype="multipart/form-data">
                      @csrf
                    <div class="col-sm-12">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control" id="choose_category_image" type="file" name="category_image[]" placeholder="" required=""multiple="multiple">
                          <div class="valid-feedback">Looks good!</div>
                        </div>
                      </div>
