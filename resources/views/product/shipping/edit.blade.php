              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    <form class="row needs-validation" action="{{route('shipping.update',$shipping->shipping_id)}}"method="post"enctype="multipart/form-data">
                      @csrf
                      @method('PUT')
                    <div class="col-sm-12">
                        <div class="mb-3">
                          <div class="col-form-label"> 
                            ...
                            <select class="js-example-placeholder-multiple col-sm-12" name="state_id" id="state">
                              ...
                              @foreach($state as $user):
                                @if($user->state_id==$shipping->state_id)
                            ...
                            <select class="js-example-placeholder-multiple col-sm-12" name="city_id" id="city">
                              <option value="">Choose City</option>
                                @foreach($city as $user):
                                  @if($user->city_id==$shipping->city_id)
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control" id="shipping_price" type="number"  value="{{$shipping->shipping_price}}"name="shipping_price" placeholder="Shipping Price" required="">
