              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    <form class="row needs-validation" action ="{{route('job_state_update',['id'=>$state->state_id])}}"method="post">
                      @csrf
                    <div class="col-sm-12">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control" id="job_state_name" type="text" name="state_name" placeholder="Job State Name*"value="{{$state->state_name}}" required="">
