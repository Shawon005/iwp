              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    <form class="row needs-validation" action="{{route('expert_state_update',['id'=>$state->state_id])}}" method="post">
                      @csrf
                    <div class="col-sm-12">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          ...
                          <input class="form-control" id="state_name" type="text" name="state_name" placeholder="State name*" value="{{$state->state_name}}">
