              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Expert Sub Category</li>
                  </ol>
                </div>
              </div>
            </div>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5>Add New Expert Sub Category</h5>
                  </div>
                  <div class="card-body add-post">
                    <form class="row needs-validation" action="{{route('expert_sub_category_update',['id'=>$sub_category->sub_category_id])}}"method="post">
                      @csrf
                      <div class="col-sm-12">
                        <div class="mb-3">
