              ...
              <div class="col-sm-12">
               ...
               @endif
                  ...
                  <div class="card-body add-post">
                    <form class="row needs-validation" action="{{route('expert_store')}}"method="post"enctype="multipart/form-data">   
                      @csrf    
                      <div class="col-sm-12">
                        <div class="row">
                          <div class="col-sm-6">
                          ...
                          <div class="col-sm-6">
                            <div class="mb-3">
                              <div class="col-form-label"> 
                                ...
                                <select class="js-example-placeholder-multiple col-sm-12" single="multiple"name="category_id"required=""id="category" >
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="mb-3 ">
                              <div class="col-form-label"> 
                                <label>State</label>
                                <select class="js-example-placeholder-multiple col-sm-12" single="multiple"required=""name="state_id"id="state">
                          ...
                          <div class="col-sm-6">
                            <div class="mb-3">
                              <div class="col-form-label"> 
                                <label>City</label>
                                <select class="js-example-placeholder-multiple col-sm-12" single="multiple"required=""name="city_id"id="city">
                          ...
                          <div class="col-sm-4">
                            ...
                            <!-- <div class="col-xl-5 col-sm-7 col-lg-8"> -->
                              <div class="input-group date" id="dt-time" data-target-input="nearest">
                                <input class="form-control datetimepicker-input digits" type="text" data-target="#dt-time"name="available_start_time">
                          ...
                          <div class="col-sm-4">
                            <div class="mb-3">
                              ...
                              <div class="input-group date" id="dt-time1" data-target-input="nearest">
                                <input class="form-control datetimepicker-input digits" type="text" data-target="#dt-time1"name="available_close_time">
                        ...
                        <div class="row">
                          <div class="col-sm-6">
                            <div class="mb-3">
                              ...
                              <input class="form-control" id="year_of_experience" type="text" name="year_of_experience" placeholder="Year of experience" required="">
                          ...
                          <div class="col-sm-6">
                            <div class="mb-3">
                              ...
                              <input class="form-control" id="base_fare" type="text" name="base_fare" placeholder="Base fare" required=""name="base_fare">
                            <div class="valid-feedback">Looks good!</div>
                          </div>
                        </div>
                        </div>
                        ...
                        <div class="card alert alert-light">
                          ...
                          <div class="p-1"id="collapseOne">
                            <input class="form-control" id="experience_details" type="text"  placeholder="" name="experience_1"id="collapseOne">
                            <div class="valid-feedback">Looks good!</div>
                            <hr> </hr>
                          </div>
                          
                          <div class="p-1"id="collapseOne">
                            <input class="form-control" id="experience_details" type="text"  placeholder="" name="experience_2"id="experience">
                            <div class="valid-feedback">Looks good!</div>
                            <hr class=""> </hr>
                          </div>
                          
                          <div class="p-1"id="collapseOne">
                            <input class="form-control" id="experience_details" type="text"  placeholder="" name="experience_3"id="experience">
                            <div class="valid-feedback">Looks good!</div>
                            <hr> </hr>
                          </div>
                          
                          <div class="p-1"id="collapseOne">
                            <input class="form-control" id="experience_details" type="text"  placeholder="" name="experience_4"id="experience">
                            <div class="valid-feedback">Looks good!</div>
                            <hr> </hr>
                          </div>
                        ...
                        <div class="card alert alert-light">
                          <div class="p-1">
                            <h5 class=" accordion-button"  data-bs-toggle="collapse" data-bs-target="#collapsetwo">Education and Qualifications<span class="text-end"onclick="ed()">+</span></h5>
                          </div>
                          <div class="p-1"id="collapsetwo">
                            <input class="form-control" id="education_and_qualification" type="text"  placeholder="" name="education_1"id="education">
                            <div class="valid-feedback">Looks good!</div>
                            <hr> </hr>
                          </div>
                         
                          <div class="p-1"id="collapsetwo">
                            <input class="form-control" id="education_and_qualification" type="text"  placeholder="" name="education_2"id="education">
                            <div class="valid-feedback">Looks good!</div>
                            <hr class=""> </hr>
                          </div>
                         
                          <div class="p-1"id="collapsetwo">
                            <input class="form-control" id="education_and_qualification" type="text"  placeholder="" name="education_3"id="education">
                            <div class="valid-feedback">Looks good!</div>
                            <hr> </hr>
                          </div>
                          
                          <div class="p-1"id="collapsetwo">
                            <input class="form-control" id="education_and_qualification" type="text"  placeholder="" name="education_4"id="education">
                            <div class="valid-feedback">Looks good!</div>
                            <hr> </hr>
                          </div>
                        ...
                        <div class="card alert alert-light">
                          ...
                          <div class="p-1"id="collapsethree">
                            <input class="form-control" id="evtra_coursestraining_details" type="text" name="additional_info_1"id="additional_info" placeholder="Extra Courses" >
                            <div class="valid-feedback">Looks good!</div>
                            <hr> </hr>
                          ...
                          <div class="p-1"id="collapsethree">
                            <input class="form-control" id="training_details" type="text" name="additional_info_2"id="additional_info" placeholder="Training Details">
                            <div class="valid-feedback">Looks good!</div>
                            <hr class=""> </hr>
                          </div>
                          
                          <div class="p-1"id="collapsethree">
                            <input class="form-control" id="others_1" type="text" name="additional_info_3" id="additional_info" placeholder="Others 1" >
                            <div class="valid-feedback">Looks good!</div>
                            <hr> </hr>
                          </div>
                         
                          <div class="p-1"id="collapsethree">
                            <input class="form-control" id="others_2" type="text"name="additional_info_4" id="additional_info" placeholder="Others 2" >
                            <div class="valid-feedback">Looks good!</div>
                            <hr> </hr>
                          </div>
                            ...
                            <div class="mb-3">
                              ...
                              <!-- <div class="col-xl-5 col-sm-9"> -->
                                <div class="input-group">
                                  <input class="form-control digits" type="date" data-language="en"name="date_of_birth">
                                </div>
                              <!-- </div> -->
                            </div>
                          </div>
