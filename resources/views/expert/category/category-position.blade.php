            ...
            <div class="page-title">
              <div class="row">
                <div class="col-12 col-sm-6">
                  <h3>Expert Category positions</h3>
                </div>
                <div class="col-12 col-sm-6">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('admin/dashboard')}}">                                       <i data-feather="home"></i></a></li>
                    <li class="breadcrumb-item">Expert Category positions</li>
              ...
              <div class="col-sm-12">
                <div class="card">
                  <div class="card-header pb-0">
                    <h5>Change Expert Category Positions</h5>
                  </div>
    ...
    $( function() {
        ...
        ul_sortable.sortable({
            ...
            update: function(event, ui) {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/expert_category_prosition_store/'+post,
