              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    <form class="row needs-validation" action="{{route('child_category_store')}}" method="Post">
                      @csrf
                    <div class="col-sm-12">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                          <div class="col-form-label"> 
                            ...
                            <select class="js-example-placeholder-multiple col-sm-12" name="sub_category_id"required=""id="sub_category_id">
