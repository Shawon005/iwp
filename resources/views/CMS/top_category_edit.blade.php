              ...
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body add-post">
                    <form class="row needs-validation" action="{{route('top_category_update',['id'=>$top->category_id])}}" method="Post"enctype="multipart/form-data">
                      @csrf
                     <div class="col-sm-12">
                        <div class="mb-3">
                        ...
                        <select class="js-example-placeholder-multiple col-sm-12"name="category_name">
                            @foreach($category as $user):
                              @if($user->category_id==$top->category_id)
