...
$(".enq-sav i").click(function () {
    ...
    if (user_id>0) {  //Check Current User is Null Means redirect to login page
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.ch == '1') {
                        ...
                        $("#chk").html(parseInt(response.value))
...
jQuery(document).ready(function ($) {
    $("#filter_submit").click(function () {
        ...
        // +"search_box_process.php?select_search=" + select_search + "&select_city=" + select_city;
    });
});
...
jQuery(document).ready(function ($) {
    $("#expert_filter_submit").click(function () {
        ...
        window.location.href = link  + select_search;
