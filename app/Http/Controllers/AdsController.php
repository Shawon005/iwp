...
class AdsController extends Controller
{
    public function Ads(Request $request)
    {
      ...
      return view('ads.create-ads',
      ['users'=>$users,'position'=>$position]);

    }
    public function Index(Request $request)
    {
      $ads=DB::table('vv_all_ads_enquiry')->where('ad_enquiry_status','inActive')->orderBy('all_ads_enquiry_id', 'DESC')->get();
      return view('ads.ads-request',
      ['ads'=>$ads]);
    ...
    public function Store(Request $request)
    {
      ...
      DB::table('vv_all_ads_enquiry')->insert([
       ...
       'ad_enquiry_photo'=>$this->uploadImage(request()->choose_ad_image),
        'ad_total_days'=>$diff,
      ...
      return redirect()->route('ads_request_table')->with('message' , 'Store was successful!');
    }
    ...
    public function Approve(Request $request,$id){
        ...
        return redirect()->route('ads_request_table');
    }
    public function Update(Request $request,$id){
        ...
        return redirect()->route('ads_request_table')->with('message' , 'Update was successful!');
    }
