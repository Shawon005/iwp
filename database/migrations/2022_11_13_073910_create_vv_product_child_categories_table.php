...
class CreateVvProductChildCategoriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vv_product_child_categories', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('vv_product_child_categories');
    }
}
